...
export const projectsData = [
  ...
  },
  {
    ...
    description:
      "A client portfolio website built with React and Vite — responsive design, smooth animations, and deployed on Vercel. Demonstrates ability to deliver polished frontend products for others.",
    techStack: ["React", "JavaScript", "Vite", "CSS"],
    tags: ["Frontend"],
    category: "frontend",
    liveUrl: "https://anurag-portfolio-ruby-six.vercel.app",
    githubUrl: "https://github.com/ankurpashine27/Anurag_Portfolio",
